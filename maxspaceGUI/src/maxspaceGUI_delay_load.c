 ...
 */
FARPROC WINAPI maxspaceGUIDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = maxspaceGUIDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = maxspaceGUIDelayLoadWin32FailureHook;
#endif
